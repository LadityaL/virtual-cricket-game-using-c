...
void Game::showResult() {
    ...
    cout << bowlingTeam->name << " " << bowlingTeam->totalRunsScored << " - "
         << bowlingTeam->wicketsLost << " (" << battingTeam->totalBallsBowled << ")" << endl << endl;

    if (battingTeam->totalRunsScored > bowlingTeam->totalRunsScored) {
        cout << battingTeam->name << " won the match by " << battingTeam->totalRunsScored - bowlingTeam->totalRunsScored
             << " runs!" << endl;
    } else if (battingTeam->totalRunsScored < bowlingTeam->totalRunsScored) {
        cout << bowlingTeam->name << " won the match by " << bowlingTeam->totalRunsScored - battingTeam->totalRunsScored
             << " runs!" << endl;
    } else {
